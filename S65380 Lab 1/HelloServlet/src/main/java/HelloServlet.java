...
/**
 * Name : SAKINAH BINTI JUSOH
 * No. Matric : S65380
 * Program name : Science Computer (Mobile Computing)
 * Course : CSM3023
 * Lab : Online WEBEX
 * Creation date : 27 March 2024
 * Modified date : None
 * Version : Version 1.0
 */
public class HelloServlet extends HttpServlet {
    ...
    protected void doGet (HttpServletRequest request, HttpServletResponse response)
        ...
        the response data; e.g text/html, text/plain. In our case, we will 
